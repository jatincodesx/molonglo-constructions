        ...
        <div className="container">
          {posts.length ? (
              ...
              {posts.map((post) => (
                <article key={post.slug} className="surface-panel overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="mt-3 font-display text-2xl font-semibold tracking-[-0.03em] text-molonglo-ink">
            ...
            <div className="surface-panel p-8">
              <h2 className="font-display text-2xl font-semibold tracking-[-0.03em] text-molonglo-ink">No blog posts published yet</h2>
